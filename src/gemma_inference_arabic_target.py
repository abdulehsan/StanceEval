"""
gemma_inference_arabic_target.py — Zero-shot stance detection using Gemma 4 31B via Cerebras
with Arabic target names and the v1 system prompt.

Runs on the same 100-row stratified subset as the English baseline.

Usage:
    python src/gemma_inference_arabic_target.py
"""
