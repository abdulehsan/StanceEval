"""
gemma_inference_test_event_favor_clause_v2.py — Zero-shot stance detection on the blind test set (ground_truth.csv)
using Gemma 4 31B via Cerebras with the event_favor_clause_v2 prompt and temperature 0.1.

Usage:
    python src/gemma_inference_test_event_favor_clause_v2.py
"""
...
RESULTS_PATH = os.path.join(PRED_DIR, "results_gemma4_31b_cerebras_test_event_favor_clause_v2.csv")
RAW_LOG_PATH = os.path.join(LOG_DIR, "results_gemma4_31b_cerebras_test_event_favor_clause_v2_raw.jsonl")
...
# ── System Prompt (event_favor_clause_v2) ─────────────────────────────────────
...
- Distinguish reporting from endorsement. Mentioning an event or policy does not by itself express a stance, unless it is framed positively (e.g. promoting, celebrating, organizing, presenting at, or personally participating in a related event, campaign, or initiative), in which case it leans Favor.
...
def main() -> None:
    ...
    print(f"   Prompt:           event_favor_clause_v2 Prompt")
