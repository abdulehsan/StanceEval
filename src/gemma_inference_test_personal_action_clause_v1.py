"""
gemma_inference_test_personal_action_clause_v1.py — Zero-shot stance detection on the blind test set (ground_truth.csv)
using Gemma 4 31B via Cerebras with the personal_action_clause_v1 prompt and temperature 0.1.

Usage:
    python src/gemma_inference_test_personal_action_clause_v1.py
"""
...
RESULTS_PATH = os.path.join(PRED_DIR, "results_gemma4_31b_cerebras_test_personal_action_clause_v1.csv")
RAW_LOG_PATH = os.path.join(LOG_DIR, "results_gemma4_31b_cerebras_test_personal_action_clause_v1_raw.jsonl")
...
# ── System Prompt (personal_action_clause_v1) ──────────────────────────────────
...
- A writer taking personal action toward the target, or asking how to access/obtain it, or expressing frustration at being unable to access it, implies support for the target (Favor) even if the tone reads as a neutral logistics question or complaint about access.
...
def main() -> None:
    ...
    print(f"   Prompt:           personal_action_clause_v1 Prompt")
