"""
openai_inference_test_ci_v3_batched_sol.py — Zero-shot stance detection on the blind test set (ground_truth.csv)
using gpt-5.6-sol via OpenAI API with prompt-level batching (BATCH_SIZE = 20) and the CI v3 guidelines.

Usage:
    python src/openai_inference_test_ci_v3_batched_sol.py
"""
...
RESULTS_PATH = os.path.join(PRED_DIR, "results_sol_openai_test_ci_v3_batched.csv")
RAW_LOG_PATH = os.path.join(LOG_DIR, "results_sol_openai_test_ci_v3_batched_raw.jsonl")
