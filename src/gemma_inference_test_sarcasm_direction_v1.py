"""
gemma_inference_test_sarcasm_direction_v1.py — Zero-shot stance detection on the blind test set (ground_truth.csv)
using Gemma 4 31B via Cerebras with the sarcasm_direction_v1 prompt and temperature 0.1.

Usage:
    python src/gemma_inference_test_sarcasm_direction_v1.py
"""
...
RESULTS_PATH = os.path.join(PRED_DIR, "results_gemma4_31b_cerebras_test_sarcasm_direction_v1.csv")
RAW_LOG_PATH = os.path.join(LOG_DIR, "results_gemma4_31b_cerebras_test_sarcasm_direction_v1_raw.jsonl")
...
# ── System Prompt (sarcasm_direction_v1) ──────────────────────────────────────
...
- When sarcasm or irony invokes a named public figure, official decree, hashtag, or slogan, first identify who or what is actually being mocked before assigning stance — sarcastic praise of the decision itself is Against, while sarcastic mockery of opposition to the decision is Favor.
...
def main() -> None:
    ...
    print(f"   Prompt:           sarcasm_direction_v1 Prompt")
