...
### Official Blind Test Set Evaluation (352 rows)
These are the official evaluation scores returned by the CodaBench platform upon submitting the zero-shot predictions generated by **Gemma 4 31B (Cerebras)** on the blind test set:
